<template>
        ...
        <div :class="$style.cilpDetail">
          <div :class="$style.clipWrapper">
            <div :class="$style.clipBox">
              <video v-if="isVideo" ref="videoRef" :class="$style.cilpGroupIcon" :src="clip" autoplay :muted="isMuted" loop playsinline />
  ...
  <Teleport to="body">
    <div v-if="isExpanded" :class="$style.fullscreen" @click="isExpanded = false">
      <video v-if="isVideo" :src="clip" :class="$style.fullImg" autoplay :muted="isMuted" loop playsinline />
